...
const HealthDashboard = ({ userData }) => {
  ...
  return (
    ...
    >
      <View style={styles.header}>
        ...
        <Text style={styles.roleText}>{userData.role.toUpperCase()} - Health Department</Text>
      </View>
        ...
        <Card key={assignment._id || assignment.id} style={styles.assignmentCard}>
          <Card.Content>
            ...
            <View style={styles.checklistContainer}>
              ...
              <Text style={styles.checklistItem}>• Facility cleanliness assessment</Text>
              <Text style={styles.checklistItem}>• Staff availability check</Text>
              <Text style={styles.checklistItem}>• Medicine stock verification</Text>
              <Text style={styles.checklistItem}>• Equipment functionality</Text>
            </View>
            ...
            >
              <Text style={styles.actionButtonText}>
                {assignment.status === "completed" ? "Completed" : "Start Health Inspection"}
              </Text>
            </TouchableOpacity>
          </Card.Content>
        </Card>
      ...
      {assignments.length === 0 && (
        <View style={styles.emptyState}>
          ...
          <Text style={styles.emptyText}>No health facility assignments found</Text>
