...
const FoodDashboard = ({ userData }) => {
  ...
  const fetchAssignments = async () => {
    try {
      ...
      const response = await api.get(`/assignments?assignedTo=${userId}&department=food`)
  ...
  return (
    ...
    >
      <View style={styles.header}>
        ...
        <Text style={styles.roleText}>{userData.role.toUpperCase()} - Food Safety Department</Text>
      </View>
        ...
        <Card key={assignment._id || assignment.id} style={styles.assignmentCard}>
          <Card.Content>
            ...
            <View style={styles.checklistContainer}>
              <Text style={styles.checklistTitle}>Food Safety Checklist:</Text>
              <Text style={styles.checklistItem}>• Kitchen hygiene assessment</Text>
              <Text style={styles.checklistItem}>• Food storage conditions</Text>
              <Text style={styles.checklistItem}>• Temperature log verification</Text>
              <Text style={styles.checklistItem}>• Expiry date checks</Text>
              <Text style={styles.checklistItem}>• Staff hygiene practices</Text>
            </View>
            ...
            >
              <Text style={styles.actionButtonText}>
                {assignment.status === "completed" ? "Completed" : "Start Food Safety Inspection"}
              </Text>
            </TouchableOpacity>
          </Card.Content>
        </Card>
      ...
      {assignments.length === 0 && (
        <View style={styles.emptyState}>
          ...
          <Text style={styles.emptyText}>No food establishment assignments found</Text>
